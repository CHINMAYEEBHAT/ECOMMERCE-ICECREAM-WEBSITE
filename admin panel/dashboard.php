...
$fetch_profile = $conn->prepare("SELECT * FROM `sellers` WHERE id = ?");
$fetch_profile->execute([$seller_id]);
$fetch_profile= $fetch_profile->fetch(PDO::FETCH_ASSOC);

if ($fetch_profile!== false) {
    $fetch_profile = $fetch_profile['name'];
 } else {
    $fetch_profile = 'No result found';
 }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section class="dashboard">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <p>sellers account</p>
                    <a href="sellers_account.php" class="btn">see sellers</a>                                            <!--####users_account.php###########-->
                </div>
                <div class="box">
                    <?php
                ...
                <div class="box">
                    <?php
                        ...
                        $select_canceled_orders->execute([$seller_id,'cancelled']);
